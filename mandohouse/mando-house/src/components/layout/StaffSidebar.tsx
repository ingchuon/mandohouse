...
const navItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/staff/teacher-payroll', label: 'ค่าสอนครู' },
      { href: '/staff/teachers', label: 'ครูผู้สอน' },
      { href: '/staff/courses', label: 'คอร์ส' },
    ],
  },
  {
    group: 'การเงิน',
    items: [
      ...
      { href: '/staff/import', label: 'ดาวน์โหลดไฟล์' },
    ],
  },
  {
    group: 'ระบบ',
